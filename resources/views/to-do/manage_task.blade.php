    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                Add/Edit/Delete tasks from  <strong>{{ $to_do->name ?? '' }}</strong>
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('update-to-do-tasks',encryptDecrypt($to_do->id,'encrypt')) }}" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
